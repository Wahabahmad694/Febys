...
node ('android-node') {
    ...
    stage('Checkout Repository') {
        ...
        env.PROJECT_NAME = (env.JOB_NAME.tokenize('/') as String[]yahuda)[0]
...
//         sh 'gradle wrapper'
        ...
        sh 'cp /var/jenkins_home/projects/android/febys/firebase_config/google-services.json app/google-services.json'
    }
