...
import com.hexagram.febys.utils.capitalizeWords
...
class TransactionPagerAdapter :
    ...
    inner class TransactionsViewHolder(
        ...
        fun bind(item: Transaction, position: Int) = with(binding) {
            ...
            tvPurpose.text = item.purpose.replace("_", " ").capitalizeWords
            tvStatus.text = item.status.substringBefore("_").capitalizeWords
